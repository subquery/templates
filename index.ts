...
export const networkFamilies: NetworkFamily[] = [
  {
    ...
    networks: [
        ...
        examples: [
          {
            name: "nibiru-starter",
            description:
              "This SubQuery project indexes all transfers and approval events for Testing ERC20 contract on Nibiru",
            remote: "https://github.com/subquery/ethereum-subql-starter",
            path: "Nibiru/nibiru-starter",
          },
        ],
      },
      {
        ...
        examples: [
          {
            ...
            description:
              "This SubQuery project indexes all transfers and approval events for the WS on Sonic Testnet",
            remote: "https://github.com/subquery/ethereum-subql-starter",
      ...
      },
      {
        ...
        logo: "https://static.subquery.network/network-logos/42429.png",
        examples: [
          {
            name: "tempo-testnet-starter",
            description:
              "This SubQuery project indexes all transfers and approval events for the pathUSD Token on Tempo testnet",
            remote: "https://github.com/subquery/ethereum-subql-starter",
            path: "Tempo/tempo-testnet-starter",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        examples: [
          {
            name: "unichain-starter",
            description:
              "This SubQuery project indexes all transfers and approval events for USDC on Unichain's Mainnet",
            remote: "https://github.com/subquery/ethereum-subql-starter",
            path: "Unichain/unichain-starter",
          },
        ],
        guides: [
          {
            ...
            description:
              "The goal of this quick start guide is to index all transfers and approval events from USDC on Unichain's Mainnet.",
        ...
        examples: [
          {
            name: "celo-alfajores-testnet-starter",
            description:
              "This SubQuery project indexes all transfers and approval events for the CELO (GoldToken) (0x471EcE3750Da237f93B8E339c536989b8978a438) on Celo Sepolia Testnet",
            remote: "https://github.com/subquery/ethereum-subql-starter",
            path: "Celo Sepolia/celo-sepolia-testnet-starter",
          },
        ],
        dictionaries: [],
      },
